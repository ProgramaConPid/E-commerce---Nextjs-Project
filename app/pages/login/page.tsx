...
export default function LoginPage() {
  ...
  <div className="w-full max-w-md bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-8">
    ...
    <header className="mb-6 text-center">
      ...
      <p className="text-sm text-gray-300 mt-1">Accede a tu cuenta y disfruta de todo lo que ofrece <span className="text-indigo-400 font-medium">TechNova</span>.</p>
    </header>
    ...
    <footer className="mt-6 text-center text-sm text-gray-300">
      ¿No tienes cuenta?{" "}
      <Link href="/pages/register" className="text-indigo-400 hover:underline font-medium">
        Crear cuenta
      </Link>
    </footer>
  </div>
